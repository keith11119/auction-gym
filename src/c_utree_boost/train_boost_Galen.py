...
def train():
    ...
    CUTreeAgent = Agent.CUTreeAgent(problem=problem, max_hist=opts.MAX_NODE_HIST, max_depth=opts.MAX_DEPTH, min_split_instances=opts.MIN_INSTANCES, training_mode=opts.TRAINING_MODE)
